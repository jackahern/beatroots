...
// find a way to find if the playlist is being edited or created
$isEdit = isset($_GET['playlist_id']) ? true : false;
if ($isEdit) {
  // get playlist details for this playlist
  $playlist = getPlaylistById($_GET['playlist_id']);
  // if playlist doesn't exist for the supplied playlist_id, then kick out back to list page and show error
  if ($playlist == NULL) {
